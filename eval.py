...
class Metrics:
    ...
    def update(self, pred, target, name):
        ...
        # print(type(count_nonzero(target)))
...
parser.add_argument("-pred", "--prediction", type=str, default="")
parser.add_argument("-o", "--output", type=str, default="")
parser.add_argument("-exp", "--exp", type=str, default="DVMD")
parser.add_argument("-gt", "--mirrormask", type=str, default="")
parser.add_argument("-db", "--dataset", type=str, default="DVMD")
